...
### EIP712 PROVIDE FIELD INFORMATION

#### Description

This command provides a trusted new display name to use for the upcoming field.
This command should come before the corresponding EIP712 SEND STRUCT IMPLEMENTATION.

If the command describes an empty name (length of 0), the upcoming field will be taken into account but
won't be shown on the device.
