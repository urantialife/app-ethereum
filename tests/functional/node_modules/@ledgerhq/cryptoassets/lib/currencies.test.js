...
test("findTokenByAddressInCurrency", function () {
    expect(tokens_1.findTokenByAddressInCurrency("0x111111111117dC0aa78b770fA6A738034120C302", "bsc")).toMatchObject({
        id: "bsc/bep20/1inch_token"
    });
    expect(tokens_1.findTokenByAddressInCurrency("0x111111111117dC0aa78b770fA6A738034120C302", "ethereum")).toMatchObject({
        id: "ethereum/erc20/1inch_token"
    });
    expect(tokens_1.findTokenByAddressInCurrency("0x0", "bsc")).toBe(undefined);
    expect(tokens_1.findTokenByAddressInCurrency("0x111111111117dC0aa78b770fA6A738034120C302", "tron")).toBe(undefined);
});
