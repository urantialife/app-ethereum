            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        rlpTx = ethers_1.ethers.utils.RLP.decode(rlpData);
                        if (txType === 2) {
                            // EIP1559
                            decodedTx = {
                                data: rlpTx[7],
                        ...
                        return [4 /*yield*/, contracts_1.loadInfosForContractMethod(decodedTx.to, selector)];
                    case 1:
                        infos = _b.sent();
                    ...
                    case 14:
                        _b.sent();
                        _b.label = 15;
                    case 15: return [2 /*return*/, utils_1.foreach(toSend, function (data, i) {
